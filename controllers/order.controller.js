  ...
  >
    <a
      ...
      >
        ...
        ></path>
        <g id="left-wing" class="left-wing">
          <path
            class="cls-1"
        ...
        <g id="right-wing" class="right-wing">
          <path
            class="cls-1"
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td style="padding-bottom: 24px">
        <p style="margin: 0px 0px 8px">Hello <strong>Riya Sharma</strong>,</p>
        <p style="margin: 0px">
          We've received your order <strong>#AM123456</strong> and it's being
          ...
          <tbody>
            ...
            <tr>
              <td
                ...
                "
              >
                Amber Rose Eau De Parfum - 100ml
              </td>
              <td
                style="
                  padding: 8px 0px;
          ...
          <tr>
            <td align="right">
              <p
                ...
                "
              >
                <span style="font-weight: 600">Subtotal:</span> ₹5897
              </p>
              <p
                style="
                  margin: 8px 0px;
                ...
                "
              >
                <span style="font-weight: 600">Shipping:</span> ₹99
              </p>
              <p
                style="
                  margin: 8px 0px;
                ...
                "
              >
                <span style="font-weight: 600">Total:</span> ₹5996
              </p>
            </td>
          </tr>
        </table>
  ...
  >
    <tr>
      <td>
        ...
        <p style="margin: 8px 0px">Riya Sharma</p>
        <p style="margin: 8px 0px">123 Blossom Street</p>
        <p style="margin: 8px 0px">Mumbai, Maharashtra - 400001</p>
        <p style="margin: 8px 0px">India</p>
        <p style="margin: 8px 0px">Phone: +91 9876543210</p>
      </td>
    </tr>
  </table>
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
